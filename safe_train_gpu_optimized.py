...
def main():
    ...
    try:
        ...
        print("\n3. 准备数据集...")
        # 使用更小的block_size
        train_dataset = TextDataset(tokenizer=tokenizer, file_path="train.txt", block_size=32)
        eval_dataset = TextDataset(tokenizer=tokenizer, file_path="eval.txt", block_size=32)
